...
<div class="hero">
    <div class="hero-inner">
        ...
        <a href="{{ url('mass-schedule') }}" class="btn">View Mass Schedule</a>
    </div>
</div>
...
<div class="cards">
    <div class="card">
        <img src="{{ asset('images/dailymass.jpg') }}" alt="Daily Holy Mass" class="card-img">
    ...
    <div class="card">
        <img src="{{ asset('images/sacraments.jpg') }}" alt="Sacraments" class="card-img">
        <h3>Sacraments</h3>
        <p>Baptism, Confirmation, Eucharist, and all sacraments of the Church are available to the faithful.</p>
    </div>
    <div class="card">
        <img src="{{ asset('images/ministries.jpg') }}" alt="Ministries" class="card-img">
        <h3>Ministries</h3>
        <p>Join one of our many active parish ministries and answer God's call to serve the community.</p>
    </div>
    <div class="card">
        <img src="{{ asset('images/events.jpg') }}" alt="News &amp; Events" class="card-img">
        <h3>News &amp; Events</h3>
